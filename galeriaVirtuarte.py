        ...
        if not self._abertoParaGravacao:
            ...
            while linha != "":
                ...
                if linha != "":
                    ...
                    lista.append(str(str(int(self.AnoDaObra)) + " " + self.MesDaObra + "  " + self.Estilo + " " + self.NomeDaObra + " " + self.AutorDaObra + " " + str(self.ValorEstimado.lstrip().ljust(12, " ")) + " " + self.urlFoto))
            return lista
